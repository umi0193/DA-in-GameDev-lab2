...
28) Добавим плоскость plane, которая позднее будет превращена в лаву добавленным ассетом огня и лавы. По аналогии с созданием яйца создаем ее через GameObject. [До]() [После]()

...
Во время выполнения 2 лабораторной работы я закрепила навыки работы с материалом, работой по загрузке и внедрению готовых пакетов, разобралась с тем, как добавить библиотеку SDK в проект и провела сравнительный анализ двух популярных платформ: Яндекс Игрыи VK Game.
